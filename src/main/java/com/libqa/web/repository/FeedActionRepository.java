...
public interface FeedActionRepository extends JpaRepository<FeedAction, Integer> {
    ...
    Integer countByFeedIdAndFeedActionTypeAndIsCanceledFalse(Integer feedId, FeedActionType feedActionType);
    Integer countByFeedReplyIdAndFeedActionTypeAndIsCanceledFalse(Integer feedReplyId, FeedActionType feedActionType);
}
