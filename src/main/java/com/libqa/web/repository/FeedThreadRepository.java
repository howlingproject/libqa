...
public interface FeedThreadRepository extends JpaRepository<FeedThread, Integer> {
    ...
    List<FeedThread> findByFeedThreadIdLessThanAndIsDeletedFalse(Integer lastFeedThreadId, Pageable pageable);
    List<FeedThread> findByUserIdAndIsDeletedFalse(Integer userId, Pageable pageable);
    List<FeedThread> findByUserIdAndFeedThreadIdLessThanAndIsDeletedFalse(Integer userId, Integer lastFeedThreadId, Pageable pageable);
